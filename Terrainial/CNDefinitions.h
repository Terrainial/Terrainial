...
#define NAVIGATION_BAR_COLOR [UIColor colorWithRed:245.0/255.0 green:245.0/255.0 blue:245.0/255.0 alpha:1.0]
...
#define NAVIGATION_BAR_FONT [UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:21.0]
